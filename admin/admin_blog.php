...
<body>
<div class="user m-3">
    <a href="../blog.php" title="Idi na vesti"><i class="fas fa-power-off"></i></a>
</div>
<div class="back">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Nova vest</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary" data-dismiss="modal"  id="dismiss-modal">Odustani</button>
            </div>
            </form>
