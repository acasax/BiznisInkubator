...
<form  method="POST" class="form-signin" id="login_form">
    <h1 class="h3 mb-3 font-weight-normal text-center">Prijava</h1>
    ...
    <div class="form-group">
        <label for="reg_password" class="control-label" >Sifra</label>
        <input type="password" name="reg_password" id="reg_password" onblur="$(this).valid()" class="form-control" >
    </div>
    <div class="form-group text-center w-100">
        <input type="submit" name="login_button" id="login_button" value="Prijavi se" class="btn btn-lg btn-primary btn-block" style="margin-top: 35px;">
    </div>
</form>
